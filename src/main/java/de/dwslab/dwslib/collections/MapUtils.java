...
public class MapUtils {
	...
	/**
	 * {@code SORTING_ORDER.ASCENDING} -> 1,2,3,4 <br>
	 * {@code SORTING_ORDER.DESCENDING} -> 4,3,2,1
	 */
	 ...
	 * @param sortingOrder The {@link SORTING_ORDER}: <br> 
	 * {@code SORTING_ORDER.ASCENDING} -> 1,2,3,4 <br>
	 * {@code SORTING_ORDER.DESCENDING} -> 4,3,2,1
	...
	public static <K extends Object, V extends Comparable<V>> Map<K, V> sortByValue(
			Map<K, V> map, final SORTING_ORDER sortingOrder) {
		...
		Collections.sort(list, new Comparator() {
			public int compare(Object o1, Object o2) {
				...
				if (sortingOrder == SORTING_ORDER.ASCENDING)
					return val;
				else if (sortingOrder == SORTING_ORDER.DESCENDING)
					return -val;
				else 
					return 0;
			}
	...
	public static void main(String[] args) {
        ...
        //sorting Map by keys
        Map<String, Integer> sortedAsc = sortByValue(olympic2012, MapUtils.SORTING_ORDER.ASCENDING);
        System.out.println("Ascending sorted Map in Java by key: " + sortedAsc);
        
        //sorting Map by keys
        Map<String, Integer> sortedDsc = sortByValue(olympic2012, MapUtils.SORTING_ORDER.DESCENDING);
